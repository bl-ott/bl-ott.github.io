...
<img src="../images/1_Kva1lwE4KCT_fdc6yHeGKQ.png" alt="1_Kva1lwE4KCT_fdc6yHeGKQ" style="zoom:50%;" />
...
> 参考[Git 内部原理 - Git 对象](https://git-scm.com/book/zh/v2/Git-%E5%86%85%E9%83%A8%E5%8E%9F%E7%90%86-Git-%E5%AF%B9%E8%B1%A1)

git object 是一个长度为 40 个字符，将待存储的数据外加一个头部信息（header）一起做 SHA-1 校验运算而得的校验和。

在`.git/objects`中存储了git仓库的全部object对象，object的前两位作为文件夹名称，剩余38位作为文件名
...
- blob - 文件
  ...
  从一次commit提交记录，查看commit、tree和blob之间的关系
...
```sh
(base) ➜  images git:(master) ✗ git cat-file -p master^{tree}
100644 blob 62bf7251e6d5b01bb8677d435700fd411734d6c5	.gitignore
100644 blob c2d3903feda33aba7b680184e00cc0a39bcdf478	404.md
100644 blob 8b137891791fe96927ad78e64b0aad7bded08bdc	CNAME
```



blob-文件，<u>内容相同的文件对应的blob是同一个</u>



### <u>把A分支的部分改动文件checkout到B分支</u>
