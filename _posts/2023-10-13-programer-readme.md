...
许多团队使用基于时间的任务分配策略，一个故事点相当于一个工作日。基于工作日的估计通常需要考虑到非任务工作——会议、中断、代码评审等，请将一个工作日定义为4个小时
...
<img src="..//images/f00c17df7ec08b43fd1a6dbf607f0007.png" alt="截图" style="zoom:50%;" />
...
也是专家（在某个垂直领域中成为佼佼者——T的竖线）。e.g.增长、多屏、视频播放cdn
